...
map_py_wrapper_impl!(
    xc3_model::ChannelAssignment,
    xc3_model_py::ChannelAssignment
);
...
mod xc3_model_py {
    ...
    use crate::map_py::MapPy;
    use crate::shader_database::shader_database::{LayerBlendMode, ShaderDatabase, ShaderProgram};
    ...
    #[pyclass]
    #[derive(Debug, Clone)]
    pub struct ChannelAssignment(pub xc3_model::ChannelAssignment);
